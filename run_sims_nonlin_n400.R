...
out.rho0.nonlinear <- run_simulation_combined(n=n, p=p, np=100, rho=0, eff_type="nonlinear",
...
out.rho5.nonlinear <- run_simulation_combined(n=n, p=p, np=100, rho=.5, eff_type="nonlinear",
                                                 beta1_seq=seq(0, .5, length=5), beta2_seq=seq(0, .5, length=5),
                                                 B=B,
                                                 hpc=hpc, errorhandling="stop", gam.big=TRUE,
                                                 bkmr.iter=20000, bkmr.exact=FALSE)
