...
out.rho0.interactive <- run_simulation_combined(n=100, p=p, rho=0, eff_type="interactive",
                                                beta1_seq=seq(0, .5, length=10), beta2_seq=seq(0, .5, length=10),
                                                B=B,
                                                hpc=hpc, errorhandling="remove", gam.big=FALSE,
                                                bkmr.iter=20000)

out.rho5.interactive <- run_simulation_combined(n=100, p=p, rho=.5, eff_type="interactive",
                                                   beta1_seq=seq(0, .5, length=10), beta2_seq=seq(0, .5, length=10),
                                                   B=B,
                                                   hpc=hpc, errorhandling="remove", gam.big=FALSE,
                                                   bkmr.iter=20000)
