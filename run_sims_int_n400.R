...
filename <- paste("outputs//interactive_sims_p", p, "_n", n, "_mcmc20000.Rdata", sep="")
...
out.rho0.interactive <- run_simulation_combined(n=n, p=p, np=100, rho=0, eff_type="interactive",
...
out.rho5.interactive <- run_simulation_combined(n=n, p=p, np=100, rho=.5, eff_type="interactive",
                                                   beta1_seq=seq(0, .5, length=5), beta2_seq=seq(0, .5, length=5),
                                                   B=B,
                                                   hpc=hpc, errorhandling="stop", gam.big=TRUE,
                                                   bkmr.iter=20000, bkmr.exact=FALSE)
...
#                                                 bkmr.iter=20000)
# save results
save(out.rho0.interactive,
     out.rho5.interactive,
